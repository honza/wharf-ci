...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_project', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'Project.slug'
        db.alter_column(u'web_project', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
