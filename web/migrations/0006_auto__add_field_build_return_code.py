...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.return_code'
        db.add_column(u'web_build', 'return_code',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.return_code'
        db.delete_column(u'web_build', 'return_code')
    ...
    models = {
        ...
        u'web.build': {
            ...
            'return_code': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
